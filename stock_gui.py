...
class SelectorApp:
     ...
     def create_widgets(self):
            ...
            EARNINGSHistRep = tk.Radiobutton(self.root, text = "Specific Stock EARNINGS", variable = self.path, value = 'EARNINGSHIST')
            EARNINGSHistRep.pack(pady=4)
